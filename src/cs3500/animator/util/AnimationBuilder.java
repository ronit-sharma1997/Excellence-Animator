...
public interface AnimationBuilder<Doc> {
   ...
   * @param type The type of shape (e.g. "ellipse", "rectangle") to be added. The set of supported
   *        shapes is unspecified, but should include "ellipse" and "rectangle" as a minimum.
   * @param layer The layer to add this shape to in the animation
   * @return This {@link AnimationBuilder}
   */
   ...
   * @param name The name of the shape (added with {@link AnimationBuilder#declareShape})
   * @param t1 The start time of this transformation
   * @param previousState Previous State of the Motion
   * @param newState New State of the Motion
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addMotion(String name,
      int t1, Attribute previousState,
   ...
   *
   * @param layer A layer in the animation in the form of the keyword layer followed by a space,
   *        then a non negative integer representing the layer in the animation.
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> declareLayer(int layer);
